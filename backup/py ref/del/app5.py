...
class MultiSelectDropdown:
    def __init__(self, parent, options, **kwargs):
        ...
        self.dropdown_button = ttk.Entry(self.parent, textvariable=self.var, **kwargs)
        self.dropdown_button.grid(row=4, column=1, padx=(0, 5), pady=5)
    ...
    def check_spelling(self):
        ...
        if user_word.strip().lower() == correct_word.strip().lower():
            ...
            if correct_word in self.words_for_test:
                print(correct_word, self.words_for_test)
