...
class SpellingTestApp:
    ...
    def setup_gui(self):
        ...
        self.test_type = ttk.Combobox(self.test_options_frame, values=["All", "Previous incorrectly spelled words", "Words practiced a week ago"], state="readonly")
        ...
        self.word_type = ttk.Combobox(self.test_options_frame, values=["All"]+list(self.word_list['word_type'].unique()), state="readonly")
        ...
        self.length_options = ttk.Combobox(self.test_options_frame, values=["All"]+list(range(1, 11)), state="readonly")
    ...
    def start_test(self):
        ...
        if test_type_filter == "All":
            self.words_for_test = self.words_for_test
