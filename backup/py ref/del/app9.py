...
class SpellingTestApp:
    def __init__(self, root):
        ...
        self.root.geometry("800x500")  # Set window size to 800x600 for more space
        ...
        self.word_list_all.columns = ["word", "word_type", "chunked_sentence",	"masked_chunked_sentence",	"example_sentence",	"masked_example_sentence", "openai_sentence", "masked_openai_sentence"]
    ...
    def setup_gui(self):
        ...
        self.user_id.current(0)  # Assuming you want the first item as default
    ...
    def start_test(self):
        ...
        if test_type_filter == "Unattended Words":
            ...
            self.words_for_test = incorrect_words_df
    ...
    def next_word(self):
        ...
        if self.words_for_test:
            ...
            masked_chunked_sentence_df = self.word_list.loc[self.word_list['word']==self.current_word.get(),"masked_chunked_sentence"]
            masked_openai_sentence_df = self.word_list.loc[self.word_list['word']==self.current_word.get(),"masked_openai_sentence"]
            ...
            mask_sent='-'+str(masked_chunked_sentence)+".\n\n-"+str(masked_openai_sentence)+"."
