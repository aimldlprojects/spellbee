...
class SpellingTestApp:
    ...
    def setup_gui(self):
        ...
        self.test_type = ttk.Combobox(self.test_options_frame, values=["All Words", "Previous incorrectly spelled words", "Words practiced a week ago"], state="readonly")
        self.test_type.grid(row=2, column=0, padx=5, pady=5)
